...
public:
    ...
    void setupUi(QMainWindow *sniffer)
    {
        ...
        PCITable->setGeometry(QRect(10, 50, 801, 321));
        trafficTable = new QTableWidget(centralwidget);
        if (trafficTable->columnCount() < 2)
            trafficTable->setColumnCount(2);
        ...
        trafficTable->setGeometry(QRect(820, 90, 221, 501));
        horizontalLayoutWidget = new QWidget(centralwidget);
        horizontalLayoutWidget->setObjectName(QString::fromUtf8("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(820, 50, 221, 31));
        ...
        PCIText->setGeometry(QRect(10, 400, 801, 191));
    ...
    void retranslateUi(QMainWindow *sniffer)
    {
        ...
        ___qtablewidgetitem9->setText(QCoreApplication::translate("sniffer", "\346\265\201\351\207\217\357\274\210\345\214\205\347\232\204\346\225\260\351\207\217\357\274\211", nullptr));
